...
1. Clone the repository:
   ...
   cd azure-image-recognition/Implement_WebApp/image-analyzer
   ```
...
The `.env` file is already created you juste need to add your computer vision resource credentials ( key and endpoint)
